...
<td height="42"><div align="center"><font color="#FFFFFF"><strong><a href="directions.jsp">Get 
  ...
  <tr bgcolor="#000099"> 
    <td colspan="5" bordercolor="0"><div align="center"><strong><font color="#FFFFFF" size="6">Show 
        Campus Resources</font></strong></div></td>
  </tr>
  <tr bgcolor="#000099"> 
    <td height="252" colspan="5" bordercolor="0"><div align="center">
        <table width="75%" border="1">
          <tr> 
            <td><font color="#FFFFFF"><strong> Campus Resources: </strong></font></td>
            <td> <strong><font color="#FFFFFF">Buiding Names</font></strong></td>
          </tr>
          <tr> 
            <td><font color="#FFFFFF">WiFi Hotspot</font></td>
            <td><font color="#FFFFFF">LKD</font></td>
          </tr>
          <tr> 
            <td><font color="#FFFFFF">Security</font></td>
            <td><font color="#FFFFFF">Wonder Plaza</font></td>
          </tr>
        </table>
      </div></td>
  </tr>
